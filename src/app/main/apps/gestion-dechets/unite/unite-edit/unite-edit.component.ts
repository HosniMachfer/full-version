...
export class UniteEditComponent implements OnInit, OnDestroy {
   ...
   */
  constructor(private router: Router, private _uniteEditService: UniteEditService,
    ...
    private dateAdapter: NgbDateAdapter<string>,private uniteListService: UniteListService,
    ...
    if (form.valid) {
      ...
      .subscribe(
        response => {
          ...
          this.router.navigate(['apps/gestion-dechets/unite/unite-list']);
        },
        error => {
