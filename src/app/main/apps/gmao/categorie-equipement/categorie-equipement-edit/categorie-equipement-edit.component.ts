...
@Component({
  selector: 'app-categorie-equipement-edit',
  templateUrl: './categorie-equipement-edit.component.html',
  styleUrls: ['./categorie-equipement-edit.component.scss'],
  providers: [
...
export class CategorieEquipementEditComponent implements OnInit, OnDestroy {
   ...
   *
   * @param {Router} router
   * @param {CategorieEquipementEditService} _CategorieEquipementEditService
   */
  constructor(private router: Router, private _categorieEquipementEditService: CategorieEquipementEditService,
    ...
    private dateAdapter: NgbDateAdapter<string>,private categorieEquipementListService: CategorieEquipementListService,
