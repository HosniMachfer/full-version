...
export class MachineListComponent implements OnInit {
 ...
 constructor(private machineListService: MachineListService,private _coreSidebarService: CoreSidebarService,private _coreTranslationService: CoreTranslationService) { 
